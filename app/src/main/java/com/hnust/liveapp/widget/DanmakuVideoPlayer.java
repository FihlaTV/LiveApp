...
public class DanmakuVideoPlayer extends StandardGSYVideoPlayer {
    ...
    private SwitchIconView mToogleDanmaku;
    ...
    protected void init(Context context) {
        ...
        mSendDanmaku = (Button) findViewById(R.id.send_danmaku);
        mToogleDanmaku = (SwitchIconView) findViewById(R.id.toogle_danmaku);

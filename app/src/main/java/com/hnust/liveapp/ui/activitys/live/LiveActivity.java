...
public class LiveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //必须在setUp之前设置
        danmakuVideoPlayer.setShrinkImageRes(R.drawable.simple_player_icon_fullscreen_shrink);
        danmakuVideoPlayer.setEnlargeImageRes(R.drawable.simple_player_icon_fullscreen_stretch);
...
//        String url = "http://baobab.wdjcdn.com/14564977406580.mp4";
        ...
        imageView.setImageResource(R.mipmap.dashi);

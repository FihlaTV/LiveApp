...
public class LayerFragment extends Fragment implements View.OnClickListener {
    ...
    public static LayerFragment newInstance(int flag) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btn_focus = (Button) view.findViewById(R.id.btn_focus);
        ...
        if (getArguments().getInt("flag") == 1) {
            ...
            tvSendfor.setVisibility(View.GONE);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        for (int x = 0; x < 1; x++) {
            messageData.add("温馨提示: 文明直播从我做起！" + x);
        }
...
//        hlvaudience.setAdapter(new AudienceAdapter(getActivity()));
    ...
    private OnCloseClickListener mCallback;
...
//        flag= getArguments().getInt("flag");
        if (context != null) {
            mCallback = (PlayerForAppActivity) context;
        }
    }
